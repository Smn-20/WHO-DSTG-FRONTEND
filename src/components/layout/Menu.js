                ...
                <aside id="layout-menu" className="layout-menu menu-vertical menu bg-menu-theme">
                    <div className="app-brand demo">
                        <span className="demo menu-text fw-bolder ms-2">
                            <img src="../assets/img/layouts/WHO.jpg" style={{ width: '100%' }} className="h-auto" alt="WHO" />
                        </span>
                        ...
                        <li className="menu-item">
                            <a className='menu-link'>
                                <button onClick={handleLogout} className="btn btn-outline-primary ml-4" type="button">
                                    <i className="fa-duotone bg-primary fa-solid fa-right-from-bracket fa-lg me-6"></i>Logout
                                </button>
                            </a>
                        </li>
                    </ul>
                        ...
                        <div className="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                            <div className="navbar-nav align-items-center">
                                <div className="nav-item d-flex align-items-center">
                                    <h3 className="card-title text-primary">Welcome {user?.email}</h3>
                                </div>
                            </div>
                                        ...
                                        <li>
                                            <div className="d-flex">
                                                ...
                                                <div className="flex-grow-1">
                                                    <span className="fw-semibold d-block">{user?.email}</span>

      ...
      >
        ...
        >
          ...
          <ul className="menu-inner py-3">
            ...
            >
              <span onClick={() => setOpen(open)} class="menu-link">
                ...
                <i
                  class={
                    open
                      ? "menu-icon tf-icons bx bx-chevron-down"
                      : "menu-icon tf-icons bx bx-chevron-right"
                  }
                  style={{ marginTop: 3 }}
                ></i>
              </span>
              ...
              >
                <li
                  class={
                    location.pathname === "/conditions"  || location.pathname === "/symptoms"
                      ? "menu-item active"
                      : "menu-item"
                  }
                >
                  ...
                  <ul
                    class="menu-sub"
                    style={{ display: open ? "block" : "none", marginLeft: 20 }}
                  >
                    <li
                      class="menu-item"
                    >
                      <Link to="/conditions" class="menu-link">
                    ...
                    <li
                      class="menu-item"
                    >
                      <Link to="/symptoms" class="menu-link">
                ...
                >
                  ...
                  >
                    <li
                      class="menu-item"
                    >
                      <Link to="/coming-soon" class="menu-link">
                        <div style={{}}>Conditions</div>
                      </Link>
                    </li>
                    <li
            ...
            {/* <li className={location.pathname === '/conditions' ? "menu-item active" : "menu-item"}>
                            <Link to='conditions' className='menu-link'>
                                <i className='menu-icon tf-icons bx bxs-virus'></i>
                                <div data-i18n="Analytics">Conditions</div>
                            </Link>
                        </li>
                        <li className={location.pathname === '/symptoms' ? "menu-item active" : "menu-item"}>
                            <Link to='symptoms' className='menu-link'>
                                <i className='menu-icon tf-icon bx bxs-bar-chart-alt-2'></i>
                                <div data-i18n="Analytics">Symptoms</div>
                            </Link>
                        </li> */}
            <li
              className={
